 ...
 459:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 5f0:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 5f5:	bb 8b 07 00 00       	mov    $0x78b,%ebx
 ...
 601:	a1 94 0a 00 00       	mov    0xa94,%eax
{
 ...
 641:	5b                   	pop    %ebx
  freep = p;
 642:	89 15 94 0a 00 00    	mov    %edx,0xa94
}
 648:	5e                   	pop    %esi
 649:	5f                   	pop    %edi
 64a:	5d                   	pop    %ebp
 ...
 677:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 67a:	89 15 94 0a 00 00    	mov    %edx,0xa94
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6db:	39 05 94 0a 00 00    	cmp    %eax,0xa94
 ...
 6fe:	e8 fd fe ff ff       	call   600 <free>
  return freep;
 703:	8b 15 94 0a 00 00    	mov    0xa94,%edx
 ...
 747:	0a 00 00 
    base.s.size = 0;
 74a:	b8 98 0a 00 00       	mov    $0xa98,%eax
    base.s.ptr = freep = prevp = &base;
 74f:	c7 05 98 0a 00 00 98 	movl   $0xa98,0xa98
 756:	0a 00 00 
    base.s.size = 0;
 759:	c7 05 9c 0a 00 00 00 	movl   $0x0,0xa9c
 760:	00 00 00 
    if(p->s.size >= nunits){
