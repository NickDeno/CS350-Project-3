...
main(void)
{
  ...
  19:	e8 45 03 00 00       	call   363 <open>
  ...
  2c:	6a 00                	push   $0x0
  2e:	e8 68 03 00 00       	call   39b <dup>
  dup(0);  // stderr
  33:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  3a:	e8 5c 03 00 00       	call   39b <dup>
  ...
  70:	e8 b6 02 00 00       	call   32b <wait>
  ...
  88:	e8 23 04 00 00       	call   4b0 <printf>
      exit();
  8d:	e8 91 02 00 00       	call   323 <exit>
      exec("sh", argv);
  92:	50                   	push   %eax
  93:	50                   	push   %eax
  94:	68 20 0b 00 00       	push   $0xb20
  ...
  c0:	e8 a6 02 00 00       	call   36b <mknod>
    open("console", O_RDWR);
  c5:	58                   	pop    %eax
  c6:	5a                   	pop    %edx
  c7:	6a 02                	push   $0x2
  c9:	68 d8 07 00 00       	push   $0x7d8
  ce:	e8 90 02 00 00       	call   363 <open>
 ...
 418:	89 d1                	mov    %edx,%ecx
{
 ...
 44b:	0f b6 92 80 08 00 00 	movzbl 0x880(%edx),%edx
 ...
 486:	50                   	push   %eax
 487:	56                   	push   %esi
 488:	e8 b6 fe ff ff       	call   343 <write>
  while(--i >= 0)
 ...
 4b9:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 4f0:	50                   	push   %eax
 4f1:	57                   	push   %edi
 4f2:	e8 4c fe ff ff       	call   343 <write>
 ...
 524:	ff 24 85 28 08 00 00 	jmp    *0x828(,%eax,4)
 ...
 561:	52                   	push   %edx
 562:	57                   	push   %edi
 563:	e8 db fd ff ff       	call   343 <write>
        putc(fd, c);
 ...
 650:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 655:	bb 1f 08 00 00       	mov    $0x81f,%ebx
 ...
 661:	a1 28 0b 00 00       	mov    0xb28,%eax
{
 ...
 6a1:	5b                   	pop    %ebx
  freep = p;
 6a2:	89 15 28 0b 00 00    	mov    %edx,0xb28
}
 6a8:	5e                   	pop    %esi
 6a9:	5f                   	pop    %edi
 6aa:	5d                   	pop    %ebp
 ...
 6d7:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6da:	89 15 28 0b 00 00    	mov    %edx,0xb28
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 73b:	39 05 28 0b 00 00    	cmp    %eax,0xb28
 741:	75 ed                	jne    730 <malloc+0x40>
  p = sbrk(nu * sizeof(Header));
 743:	83 ec 0c             	sub    $0xc,%esp
 746:	56                   	push   %esi
 747:	e8 5f fc ff ff       	call   3ab <sbrk>
  if(p == (char*)-1)
 ...
 75e:	e8 fd fe ff ff       	call   660 <free>
  return freep;
 763:	8b 15 28 0b 00 00    	mov    0xb28,%edx
 ...
 78c:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 78f:	89 15 28 0b 00 00    	mov    %edx,0xb28
}
 ...
 7a7:	0b 00 00 
    base.s.size = 0;
 7aa:	b8 2c 0b 00 00       	mov    $0xb2c,%eax
    base.s.ptr = freep = prevp = &base;
 7af:	c7 05 2c 0b 00 00 2c 	movl   $0xb2c,0xb2c
 7b6:	0b 00 00 
    base.s.size = 0;
 7b9:	c7 05 30 0b 00 00 00 	movl   $0x0,0xb30
 7c0:	00 00 00 
    if(p->s.size >= nunits){
