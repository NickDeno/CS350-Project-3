 ...
 409:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 5a0:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 5a5:	bb 2e 07 00 00       	mov    $0x72e,%ebx
...
free(void *ap)
{
 ...
 5b1:	a1 2c 0a 00 00       	mov    0xa2c,%eax
{
 ...
 5f1:	5b                   	pop    %ebx
  freep = p;
 5f2:	89 15 2c 0a 00 00    	mov    %edx,0xa2c
}
 5f8:	5e                   	pop    %esi
 5f9:	5f                   	pop    %edi
 5fa:	5d                   	pop    %ebp
 ...
 627:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 62a:	89 15 2c 0a 00 00    	mov    %edx,0xa2c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 649:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 64c:	8b 15 2c 0a 00 00    	mov    0xa2c,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 68b:	39 05 2c 0a 00 00    	cmp    %eax,0xa2c
 ...
 6ae:	e8 fd fe ff ff       	call   5b0 <free>
  return freep;
 6b3:	8b 15 2c 0a 00 00    	mov    0xa2c,%edx
 ...
 6dc:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 6df:	89 15 2c 0a 00 00    	mov    %edx,0xa2c
}
 ...
 6ef:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 6f0:	c7 05 2c 0a 00 00 30 	movl   $0xa30,0xa2c
 6f7:	0a 00 00 
    base.s.size = 0;
 6fa:	b8 30 0a 00 00       	mov    $0xa30,%eax
    base.s.ptr = freep = prevp = &base;
 6ff:	c7 05 30 0a 00 00 30 	movl   $0xa30,0xa30
 706:	0a 00 00 
    base.s.size = 0;
 709:	c7 05 34 0a 00 00 00 	movl   $0x0,0xa34
 710:	00 00 00 
    if(p->s.size >= nunits){
