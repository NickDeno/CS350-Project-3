...
main(void)
{
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
      40:	80 3d 62 19 00 00 20 	cmpb   $0x20,0x1962
...
fork1(void)
{
  ...
  memset(buf, 0, nbuf);
      ...
      79:	6a 64                	push   $0x64
      7b:	6a 00                	push   $0x0
      7d:	68 60 19 00 00       	push   $0x1960
      82:	e8 29 0b 00 00       	call   bb0 <memset>
  gets(buf, nbuf);
      87:	58                   	pop    %eax
      88:	5a                   	pop    %edx
      89:	6a 64                	push   $0x64
      8b:	68 60 19 00 00       	push   $0x1960
      90:	e8 7b 0b 00 00       	call   c10 <gets>
  if(buf[0] == 0) // EOF
      95:	0f b6 05 60 19 00 00 	movzbl 0x1960,%eax
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
      ...
      a7:	80 3d 61 19 00 00 64 	cmpb   $0x64,0x1961
  ...
  exit();
     ...
     105:	51                   	push   %ecx
     106:	68 63 19 00 00       	push   $0x1963
     10b:	68 c5 12 00 00       	push   $0x12c5
     110:	6a 02                	push   $0x2
    ...
    panic("fork");
     ...
     122:	68 4b 12 00 00       	push   $0x124b
...
00000170 <panic>:
{
  ...
  printf(2, "%s\n", s);
     ...
     179:	68 b9 12 00 00       	push   $0x12b9
     17e:	6a 02                	push   $0x2
...
00000190 <runcmd>:
{
  ...
  switch(cmd->type){
     ...
     1a9:	ff 24 85 f4 12 00 00 	jmp    *0x12f4(,%eax,4)
    printf(2, "Pipe Not implemented\n");
     1b0:	52                   	push   %edx
     1b1:	52                   	push   %edx
     1b2:	68 35 12 00 00       	push   $0x1235
     1b7:	6a 02                	push   $0x2
     1b9:	e8 02 0d 00 00       	call   ec0 <printf>
    break;
    ...
    printf(2, "Backgrounding not implemented\n");
     1cd:	50                   	push   %eax
     1ce:	50                   	push   %eax
     1cf:	68 d4 12 00 00       	push   $0x12d4
     1d4:	6a 02                	push   $0x2
     1d6:	e8 e5 0c 00 00       	call   ec0 <printf>
    break;
    ...
    printf(2, "exec %s failed\n", ecmd->argv[0]);
     ...
     1f9:	68 f2 11 00 00       	push   $0x11f2
     1fe:	6a 02                	push   $0x2
     200:	e8 bb 0c 00 00       	call   ec0 <printf>
    break;
    ...
    printf(2, "Redirection Not Implemented\n");
     20a:	53                   	push   %ebx
     20b:	53                   	push   %ebx
     20c:	68 02 12 00 00       	push   $0x1202
     211:	6a 02                	push   $0x2
     213:	e8 a8 0c 00 00       	call   ec0 <printf>
    break;
    ...
    printf(2, "List Not Implemented\n");
     21d:	51                   	push   %ecx
     21e:	51                   	push   %ecx
     21f:	68 1f 12 00 00       	push   $0x121f
     224:	6a 02                	push   $0x2
     226:	e8 95 0c 00 00       	call   ec0 <printf>
    break;
     22b:	83 c4 10             	add    $0x10,%esp
     22e:	eb 98                	jmp    1c8 <runcmd+0x38>
    panic("runcmd");
     230:	83 ec 0c             	sub    $0xc,%esp
     233:	68 eb 11 00 00       	push   $0x11eb
...
00000240 <fork1>:
{
  ...
  return pid;
    ...
    panic("fork");
     ...
     255:	68 4b 12 00 00       	push   $0x124b
...
execcmd(void)
{
  ...
  cmd = malloc(sizeof(*cmd));
     267:	6a 54                	push   $0x54
     269:	e8 92 0e 00 00       	call   1100 <malloc>
...
pipecmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     2e7:	6a 0c                	push   $0xc
     2e9:	e8 12 0e 00 00       	call   1100 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
listcmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     327:	6a 0c                	push   $0xc
     329:	e8 d2 0d 00 00       	call   1100 <malloc>
  memset(cmd, 0, sizeof(*cmd));
     ...
     399:	8b 45 08             	mov    0x8(%ebp),%eax
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     3bd:	50                   	push   %eax
     3be:	68 3c 19 00 00       	push   $0x193c
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     40d:	50                   	push   %eax
     40e:	68 3c 19 00 00       	push   $0x193c
  ...
  *ps = s;
  ...
  while(s < es && strchr(whitespace, *s))
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     456:	50                   	push   %eax
     457:	68 34 19 00 00       	push   $0x1934
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     475:	50                   	push   %eax
     476:	68 3c 19 00 00       	push   $0x193c
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     52d:	50                   	push   %eax
     52e:	68 3c 19 00 00       	push   $0x193c
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     593:	68 6d 12 00 00       	push   $0x126d
     598:	53                   	push   %ebx
     599:	56                   	push   %esi
  ...
  cmd = malloc(sizeof(*cmd));
     5f0:	6a 18                	push   $0x18
     5f2:	e8 09 0b 00 00       	call   1100 <malloc>
  memset(cmd, 0, sizeof(*cmd));
  ...
  cmd = malloc(sizeof(*cmd));
     64f:	6a 18                	push   $0x18
     651:	e8 aa 0a 00 00       	call   1100 <malloc>
  memset(cmd, 0, sizeof(*cmd));
  ...
  return cmd;
     ...
     6ae:	68 50 12 00 00       	push   $0x1250
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     6cf:	68 70 12 00 00       	push   $0x1270
     6d4:	56                   	push   %esi
     6d5:	53                   	push   %ebx
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     6eb:	6a 54                	push   $0x54
     6ed:	e8 0e 0a 00 00       	call   1100 <malloc>
  memset(cmd, 0, sizeof(*cmd));
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     736:	68 87 12 00 00       	push   $0x1287
     73b:	56                   	push   %esi
     73c:	53                   	push   %ebx
    ...
    if(argc >= MAXARGS)
     ...
     780:	68 79 12 00 00       	push   $0x1279
  ...
  cmd->eargv[argc] = 0;
     ...
     7c9:	68 72 12 00 00       	push   $0x1272
...
000007e0 <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     7f9:	68 8c 12 00 00       	push   $0x128c
  cmd = parseexec(ps, es);
  ...
  cmd = malloc(sizeof(*cmd));
     83d:	e8 be 08 00 00       	call   1100 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
00000870 <parseline>:
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     8a2:	e8 59 08 00 00       	call   1100 <malloc>
  memset(cmd, 0, sizeof(*cmd));
  ...
  while(peek(ps, es, "&")){
     ...
     8cb:	68 8e 12 00 00       	push   $0x128e
     8d0:	57                   	push   %edi
     8d1:	56                   	push   %esi
  ...
  if(peek(ps, es, ";")){
     ...
     8e1:	68 8a 12 00 00       	push   $0x128a
     8e6:	57                   	push   %edi
     8e7:	56                   	push   %esi
  ...
  cmd = malloc(sizeof(*cmd));
     91d:	e8 de 07 00 00       	call   1100 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
00000950 <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     95f:	68 70 12 00 00       	push   $0x1270
     964:	56                   	push   %esi
     965:	53                   	push   %ebx
  ...
  if(!peek(ps, es, ")"))
     ...
     989:	68 ac 12 00 00       	push   $0x12ac
  cmd = parseline(ps, es);
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     9f9:	ff 24 85 0c 13 00 00 	jmp    *0x130c(,%eax,4)
     ...
     a85:	8d 7d 08             	lea    0x8(%ebp),%edi
{
  ...
  peek(&s, es, "");
     ...
     aa3:	68 01 12 00 00       	push   $0x1201
  cmd = parseline(&s, es);
  ...
  nulterminate(cmd);
    ...
    printf(2, "leftovers: %s\n", s);
     ace:	52                   	push   %edx
     acf:	50                   	push   %eax
     ad0:	68 ae 12 00 00       	push   $0x12ae
     ad5:	6a 02                	push   $0x2
     ad7:	e8 e4 03 00 00       	call   ec0 <printf>
    panic("syntax");
     adc:	c7 04 24 72 12 00 00 	movl   $0x1272,(%esp)
...
00000e0b <cont>:
SYSCALL(cont)
     e0b:	b8 1d 00 00 00       	mov    $0x1d,%eax
     e10:	cd 40                	int    $0x40
     e12:	c3                   	ret
     ...
     e28:	89 d1                	mov    %edx,%ecx
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     e5b:	0f b6 92 84 13 00 00 	movzbl 0x1384(%edx),%edx
  ...
  write(fd, &c, 1);
     ...
     e96:	50                   	push   %eax
     e97:	56                   	push   %esi
     e98:	e8 b6 fe ff ff       	call   d53 <write>
  while(--i >= 0)
     ...
     ec9:	8b 75 0c             	mov    0xc(%ebp),%esi
{
  ...
  write(fd, &c, 1);
     ...
     f00:	50                   	push   %eax
     f01:	57                   	push   %edi
     f02:	e8 4c fe ff ff       	call   d53 <write>
  ...
  for(i = 0; fmt[i]; i++){
    ...
    if(state == 0){
     ...
     f34:	ff 24 85 2c 13 00 00 	jmp    *0x132c(,%eax,4)
  ...
  write(fd, &c, 1);
     ...
     f60:	57                   	push   %edi
     f61:	e8 ed fd ff ff       	call   d53 <write>
     ...
     f71:	52                   	push   %edx
     f72:	57                   	push   %edi
     f73:	e8 db fd ff ff       	call   d53 <write>
        putc(fd, c);
  ...
  write(fd, &c, 1);
     ...
     feb:	53                   	push   %ebx
     fec:	57                   	push   %edi
     fed:	e8 61 fd ff ff       	call   d53 <write>
        while(*s != 0){
  ...
  write(fd, &c, 1);
    ...
    1060:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
    1065:	bb 24 13 00 00       	mov    $0x1324,%ebx
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1071:	a1 c4 19 00 00       	mov    0x19c4,%eax
{
  ...
  freep = p;
    ...
    10b1:	5b                   	pop    %ebx
  freep = p;
    10b2:	89 15 c4 19 00 00    	mov    %edx,0x19c4
}
    10b8:	5e                   	pop    %esi
    10b9:	5f                   	pop    %edi
    10ba:	5d                   	pop    %ebp
  ...
  freep = p;
    10ea:	89 15 c4 19 00 00    	mov    %edx,0x19c4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    110c:	8b 15 c4 19 00 00    	mov    0x19c4,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    114b:	39 05 c4 19 00 00    	cmp    %eax,0x19c4
    1151:	75 ed                	jne    1140 <malloc+0x40>
  p = sbrk(nu * sizeof(Header));
    1153:	83 ec 0c             	sub    $0xc,%esp
    1156:	56                   	push   %esi
    1157:	e8 5f fc ff ff       	call   dbb <sbrk>
  if(p == (char*)-1)
  ...
  return freep;
    1173:	8b 15 c4 19 00 00    	mov    0x19c4,%edx
    ...
    119c:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
    119f:	89 15 c4 19 00 00    	mov    %edx,0x19c4
}
    ...
    11af:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
    11b0:	c7 05 c4 19 00 00 c8 	movl   $0x19c8,0x19c4
    11b7:	19 00 00 
    base.s.size = 0;
    11ba:	b8 c8 19 00 00       	mov    $0x19c8,%eax
    base.s.ptr = freep = prevp = &base;
    11bf:	c7 05 c8 19 00 00 c8 	movl   $0x19c8,0x19c8
    11c6:	19 00 00 
    base.s.size = 0;
    11c9:	c7 05 cc 19 00 00 00 	movl   $0x0,0x19cc
    11d0:	00 00 00 
    if(p->s.size >= nunits){
