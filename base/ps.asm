 ...
 3e9:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 50b:	53                   	push   %ebx
 50c:	57                   	push   %edi
 50d:	e8 61 fd ff ff       	call   273 <write>
        while(*s != 0){
 ...
 55b:	52                   	push   %edx
 55c:	57                   	push   %edi
 55d:	e8 11 fd ff ff       	call   273 <write>
        ap++;
...
free(void *ap)
{
 ...
 591:	a1 fc 09 00 00       	mov    0x9fc,%eax
{
 ...
 5d1:	5b                   	pop    %ebx
  freep = p;
 5d2:	89 15 fc 09 00 00    	mov    %edx,0x9fc
}
 5d8:	5e                   	pop    %esi
 5d9:	5f                   	pop    %edi
 5da:	5d                   	pop    %ebp
 ...
 607:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 60a:	89 15 fc 09 00 00    	mov    %edx,0x9fc
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 629:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 62c:	8b 15 fc 09 00 00    	mov    0x9fc,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 66b:	39 05 fc 09 00 00    	cmp    %eax,0x9fc
 671:	75 ed                	jne    660 <malloc+0x40>
  p = sbrk(nu * sizeof(Header));
 673:	83 ec 0c             	sub    $0xc,%esp
 676:	56                   	push   %esi
 677:	e8 5f fc ff ff       	call   2db <sbrk>
  if(p == (char*)-1)
 ...
 68e:	e8 fd fe ff ff       	call   590 <free>
  return freep;
 693:	8b 15 fc 09 00 00    	mov    0x9fc,%edx
 ...
 6bc:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 6bf:	89 15 fc 09 00 00    	mov    %edx,0x9fc
}
 ...
 6cf:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 6d0:	c7 05 fc 09 00 00 00 	movl   $0xa00,0x9fc
 6d7:	0a 00 00 
    base.s.size = 0;
 6da:	b8 00 0a 00 00       	mov    $0xa00,%eax
    base.s.ptr = freep = prevp = &base;
 6df:	c7 05 00 0a 00 00 00 	movl   $0xa00,0xa00
 6e6:	0a 00 00 
    base.s.size = 0;
 6e9:	c7 05 04 0a 00 00 00 	movl   $0x0,0xa04
 6f0:	00 00 00 
    if(p->s.size >= nunits){
